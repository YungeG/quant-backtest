...
MODULE = (
    ...
    / "cn_a_share_current_selected_rule_bundle.py"
)
BUILDER_ROOT = (
    ROOT
    / "packages/market-bundle-builder/src/crypto_quant_bundle_builder/__init__.py"
)
SEAM = "project_cn_a_share_current_selected_rule_authority_events_v2"


def test_current_selected_projection_stays_internal_kernel_free_and_compositional() -> (
    None
):
    ...
    assert "cn_a_share_current_selected_rule_bundle" not in root_source
