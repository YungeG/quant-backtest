...
def book_fill(value: Any, lots: tuple[PositionLot, ...] = ()) -> Any:
...
def test_add_and_partial_sell_use_fifo_independent_of_input_order() -> None:
    ...
    sell = fill("3", side=OrderSide.SELL, quantity_units=25, price_units=13_000, execution_time=30)
...
def test_full_sell_closes_all_lots_and_zero_gross_pnl_is_not_attributed() -> None:
    ...
    sell = fill("2", side=OrderSide.SELL, quantity_units=20, price_units=10_000, execution_time=20)
...
def test_sell_beyond_long_lots_fails_without_implicit_short() -> None:
    buy = fill("1", side=OrderSide.BUY, quantity_units=10, price_units=10_000, execution_time=10)
    bought = book_fill(buy).result
    assert bought is not None
    sell = fill("2", side=OrderSide.SELL, quantity_units=11, price_units=11_000, execution_time=20)
...
def test_partial_consumption_splits_allocated_fee_exactly() -> None:
    ...
    sell = fill("2", side=OrderSide.SELL, quantity_units=10, price_units=11_000, execution_time=20)
