...
readiness: A_SHARE_V2_ACCEPTED_H1_JULY_LISTING_BINDING_ACCEPTED_V1_IMMUTABLE_H2_BINANCE_H3_PERMANENT_BLOCK
gate_status: DRAFT
...
consumes:
  ...
  - accepted G12L Tushare fixed-singleton listing-presence evidence slices for 20240102 and the exact 19 July-2026 dates
...
listing report as post-assessment evidence only. Its direct-successor July binding
now additionally binds one exact historical-list row for each of the 19 accepted G12I
provider dates. Resolution remains compatibility authority and Integrity remains sole
...
limitation/nonclaim, not an H2 cause. The accepted listing-presence bindings do not
change route or assessment status, establish provider-time availability before the
Run, prove continuity between observed dates, or alter grade.
...
| G12L Tushare July listing presence | `ACCEPTED DIRECT-SUCCESSOR POST-ASSESSMENT BINDING`: exactly one matching `bak_basic` row is retained for every accepted G12I July-2026 provider date and bound as the direct successor of listing binding-v1. Observation remains later than the Run/assessment and does not prove between-date continuity. | G12L report `sha256:4c829bf707bf0876ada550ad44682d0fc362025379afe233b98e9d7751e22052`; canonical file `sha256:36b38ec4367a4c9945c4ee8caee9b31eeb57bf73f6c10ed93526d0306d281e6c`; G12M binding `sha256:30d1ef7480ad435e5a1e3f4948891c7d2f8c412b16731155bd5d2bf14126342f`. |
