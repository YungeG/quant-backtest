...
| [G12L-TUSHARE-CN-A-SHARE-AUTHORITY-ACQUISITION-V1](g12l-tushare-cn-a-share-authority-acquisition-v1.md) | Additive listing/name/adjustment/dividend source capture — `IMPLEMENTED / LIVE_CAPTURE_PENDING`; all qualification remains false | G12A, acquisition tools, trade calendar | `tools/acquisition/cn_a_share_tushare_authority.py` |
