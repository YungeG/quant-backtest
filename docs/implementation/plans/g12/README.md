...
| [G12CD-TUSHARE-CN-A-SHARE-DAILY-PUBLICATION-V2](g12cd-tushare-cn-a-share-daily-publication-v2.md) | Additive one-instrument catalog-bound publication — `READY`; plan `33e0b9b`; current metadata only, no historical listing/survivorship authority | Tushare publication v1, G12C, G12D | internal Builder projection |
...
| [G12H](g12h.md) | Rule coverage — `DRAFT / BLOCKED`; exact current Bundle fails earliest at `COVERAGE_GAP / market_fees` because 2023 fee/tax bands do not cover the July 2026 target | G12C + aligned five-dimension rule authority | builder validation |
