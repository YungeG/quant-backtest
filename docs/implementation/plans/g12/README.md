...
| [G12K](g12k.md) | Universe/corporate-action coverage — readiness `BLOCKED`, Gate `DRAFT`; [July-2026 development v1](g12k-july-2026-development-coverage-v1.md) freezes the documentation-only D1 contract | G12C + normalized schemas/closure declarations | builder validation |
