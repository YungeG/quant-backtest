...
| [G12H-EFFECTIVE-UNTIL-SUPERSEDED-V2](g12h-effective-until-superseded-v2.md) | Additive successor-closure path — `BLOCKED`; route/product v2 contract approved and V2A READY, but V2B/V2C must PASSED before F1 resumes | G08E-ROUTE-PRODUCT-FEE-V2C plus official predecessor/endpoint/index evidence | staged contract/research/build publication |
