...
| [G12L-BINANCE-USDM-FUNDING-RATE-V1](g12l-binance-usdm-funding-rate-v1.md) | Third concrete slice — `DRAFT / READY FOR ACCEPTANCE`; rate-only normalization and G12C/D evidence frozen | G10E, G12A-D + Binance public-data evidence | Builder Binance USD-M source slice |
