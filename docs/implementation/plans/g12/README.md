...
| [G12CD-TUSHARE-CN-A-SHARE-DAILY-PUBLICATION-V1](g12cd-tushare-cn-a-share-daily-publication-v1.md) | One internal Tushare result→Event projection composed through unchanged G12C/D — `IMPLEMENTED / ACCEPTANCE_PENDING` | G12B Tushare result, G12C, G12D | internal Builder projection |
