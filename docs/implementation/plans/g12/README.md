...
| [G12H-CURRENT-SELECTED-DEVELOPMENT-V1](g12h-current-selected-development-v1.md) | Additive option-B development path — `READY_FOR_D1_SNAPSHOT`; current official selections may support finite July-2026 RuleBooks while all official/decision/live/deployment qualification stays false | ADR 0007, G12H live-status API probes, G08E-ROUTE-PRODUCT-FEE-V2C, G12C/D | snapshot + existing v2 values + internal Builder publication |
