...
| [G12H-CURRENT-SELECTED-DEVELOPMENT-V1](g12h-current-selected-development-v1.md) | Additive option-B development path — D1-D3 `PASSED` at `cdc5a29133bbc0b863ec409219fb50bd0b299c77`; D4 coverage `PASSED` at `0215ed3a369bff10a64830c462c569b378914670`; D5 Runtime fan-in `PASSED` at `d1a472091deb7d844e696a814e9e52e46976ece4`; all official/provider/rule-qualification/decision/live/deployment flags stay false | ADR 0007, G12H live-status API probes, G08E-ROUTE-PRODUCT-FEE-V2C, G12C/D | snapshot + existing v2 values + internal Builder publication + coverage analyzer + off-root Runtime binding |
