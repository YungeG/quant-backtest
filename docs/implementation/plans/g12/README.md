...
| [G12M-SOURCE-BOUNDED-QUALIFICATION-V1](g12m-source-bounded-qualification-v1.md) | Governance accepted; exact Tushare A-share and Binance funding-history nominal boundaries are ready for provider-specific interface design; general/dynamic-universe cases remain blocked | accepted G12I/G12K Tushare artifacts and accepted Binance funding-history v2 report | Runtime read-only qualification |
