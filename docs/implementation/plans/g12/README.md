...
| [G12I-TUSHARE-CN-A-SHARE-DAILY-SOURCE-BOUNDED-V2](g12i-tushare-cn-a-share-daily-source-bounded-v2.md) | D1 contract frozen for exact `000001.SZ` July-2026 Tushare daily/calendar/suspension evidence; D2-D4 blocked on secure credentialed capture and implementation; provider finality/completeness remain limitations under ADR 0008 | ADR 0008, G12A, existing Tushare daily publication/purpose scope | bounded acquisition + internal Builder observation |
