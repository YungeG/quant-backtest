...
| [G12H-EFFECTIVE-UNTIL-SUPERSEDED-V2](g12h-effective-until-superseded-v2.md) | Additive successor-closure path — `READY_FOR_F1_AUTHORITY_CLOSURE`; route/product V2A/V2B/V2C PASSED; only `DOMESTIC + ORDINARY_A_SHARE` predecessor/endpoint/successor evidence work resumes | G08E-ROUTE-PRODUCT-FEE-V2C plus official predecessor/endpoint/index evidence | staged contract/research/build publication |
