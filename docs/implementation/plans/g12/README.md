...
| [G12M-SOURCE-BOUNDED-QUALIFICATION-V1](g12m-source-bounded-qualification-v1.md) | Governance accepted; exact G12I nominal reconstruction boundary frozen; implementation still waits on G12K and Binance provider slices | G12I SZSE, G12K SZSE/CNINFO, Binance FAPI observed-as-of | Runtime read-only qualification |
