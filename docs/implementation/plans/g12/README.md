...
| [G12L-TUSHARE-CN-A-SHARE-AUTHORITY-ACQUISITION-V1](g12l-tushare-cn-a-share-authority-acquisition-v1.md) | Additive listing/name/adjustment/dividend source capture — `EVIDENCE_FROZEN / ACCEPTANCE_PENDING`; snapshot `sha256:bd8ae548949696f1c98f8a20b5c8653f64121fc2eee61c1ff2ac21a97d248c0d`; all qualification remains false | G12A, acquisition tools, trade calendar | `tools/acquisition/cn_a_share_tushare_authority.py` |
