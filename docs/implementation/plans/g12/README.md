...
| [G12M-SOURCE-BOUNDED-QUALIFICATION-V1](g12m-source-bounded-qualification-v1.md) | Governance accepted; exact G12I + fixed-singleton G12K nominal boundaries make one Tushare-only A-share case ready for interface design; general/dynamic-universe and Binance cases remain blocked | accepted G12I and G12K Tushare artifacts; Binance FAPI observed-as-of for Binance case | Runtime read-only qualification |
