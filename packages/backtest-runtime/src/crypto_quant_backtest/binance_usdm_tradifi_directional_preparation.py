"""V3 directional preparation over separately verified target-free economics."""
...
class BinanceUsdmTradifiDirectionalPreparationV3:
    """One V3 target overlay paired only at planning time with V3 economics."""

    directional_authority: KoruDirectionalV3StrategyAuthority
    target: BinanceUsdmKoruDirectionalTargetConsumptionV3
    economics: KoruTradifiEconomicsAuthorityV3
    ...
    def __post_init__(self) -> None:
        if (
            ...
            or type(self.economics) is not KoruTradifiEconomicsAuthorityV3
...
def prepare_binance_usdm_tradifi_directional_bar_backtest(
    *, experiment_id: str, market_reader: MarketBundleReader, provider_inputs: BinanceUsdmTradifiProviderInputs,
    ...
    """Publish request@1/input@8 only after both V3 authorities verify."""
    ...
    try:
        ...
        values = BinanceUsdmTradifiDirectionalPreparationV3(directional, target, economics, intent)
