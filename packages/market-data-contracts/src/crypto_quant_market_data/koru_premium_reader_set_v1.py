"""Shared sealed KORU premium-reader bindings, independent of Builder and Runtime."""
...
class KoruPremiumReaderBindingV1:
    """One sealed premium identity and its non-canonical live local reader."""
    ...
    def __post_init__(self) -> None:
        ...
        for name in (
            "recipe_digest", "compiler_result_digest", "scope_digest", "source_fragment_digest",
            "target_stream_digest", "overlay_bundle_digest", "economics_bundle_digest", "economics_authority_digest",
        ):
        ...
        if (
            ...
            or self.compiler_result_ref.schema_version != 1
            ...
            or self.source_projection_ref.artifact_type != "binance_usdm_koru_source_projection"
            or self.source_projection_ref.schema_version != 2
            ...
            or not isinstance(self.reader, MarketBundleReader)
        ):
    ...
    def to_canonical_dict(self) -> dict[str, object]:
        ...
        return {
            "type": "koru_premium_reader_binding_v1",
...
@dataclass(frozen=True, slots=True)
class KoruPremiumReaderSetV1:
    """The exact ordered PRM-01..04 reader declaration and its live accessors."""

    bindings: tuple[KoruPremiumReaderBindingV1, ...]
    reader_set_digest: str = field(init=False)

    def __post_init__(self) -> None:
        if type(self.bindings) is not tuple or any(type(row) is not KoruPremiumReaderBindingV1 for row in self.bindings):
        ...
        shared = (
            ...
            "source_projection_ref", "source_fragment_digest", "economics_bundle_ref",
            "economics_bundle_digest", "economics_authority_digest",
        )
    ...
    def to_canonical_dict(self) -> dict[str, object]:
        return {
            "type": "koru_premium_reader_set_v1",
...
__all__ = ["KoruPremiumReaderBindingV1", "KoruPremiumReaderSetV1"]
