...
for source_dir in sorted(path.parent for path in ROOT.glob("*/*/response.headers")):
    ...
    source_receipt = {
        "type": "g12h_register_discovery_sensitive_response_header_receipt_v1",
        "schema_version": 1,
...
manifest = {
    "type": "g12h_register_discovery_private_header_manifest_v1",
    "schema_version": 1,
...
public = {
    "type": "g12h_register_discovery_private_header_store_receipt_v1",
    "schema_version": 1,
